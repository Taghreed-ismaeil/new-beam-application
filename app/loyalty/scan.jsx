...
const RARITY_TOKEN_LOOKUP = {
  ...
  POTATO_CUBES_QR_NORMAL: { itemName: "Potato Cubes 🥔", tier: "normal" },
  POTATO_CUBES_QR_RARE: { itemName: "Potato Cubes 🥔", tier: "rare" },
  POTATO_CUBES_QR_SUPER: { itemName: "Potato Cubes 🥔", tier: "super" },
  SHAWARMA_RICE_FATTEH_QR_NORMAL: { itemName: "Shawarma Fatteh with Rice 🍚", tier: "normal" },
  SHAWARMA_RICE_FATTEH_QR_RARE: { itemName: "Shawarma Fatteh with Rice 🍚", tier: "rare" },
  SHAWARMA_RICE_FATTEH_QR_SUPER: { itemName: "Shawarma Fatteh with Rice 🍚", tier: "super" },
  SHAWARMA_FATTEH_QR_NORMAL: { itemName: "Shawarma Fatteh 🍞", tier: "normal" },
  SHAWARMA_FATTEH_QR_RARE: { itemName: "Shawarma Fatteh 🍞", tier: "rare" },
  SHAWARMA_FATTEH_QR_SUPER: { itemName: "Shawarma Fatteh 🍞", tier: "super" },
  FALAFEL_FATTEH_QR_NORMAL: { itemName: "Falafel Fatteh 🧆", tier: "normal" },
  FALAFEL_FATTEH_QR_RARE: { itemName: "Falafel Fatteh 🧆", tier: "rare" },
  FALAFEL_FATTEH_QR_SUPER: { itemName: "Falafel Fatteh 🧆", tier: "super" },
  MAC_CHEESE_QR_NORMAL: { itemName: "Mac and Cheese 🧀", tier: "normal" },
  MAC_CHEESE_QR_RARE: { itemName: "Mac and Cheese 🧀", tier: "rare" },
  MAC_CHEESE_QR_SUPER: { itemName: "Mac and Cheese 🧀", tier: "super" },
  MEXICAN_FRIES_QR_NORMAL: { itemName: "Mexican Fries 🌶️", tier: "normal" },
  MEXICAN_FRIES_QR_RARE: { itemName: "Mexican Fries 🌶️", tier: "rare" },
  MEXICAN_FRIES_QR_SUPER: { itemName: "Mexican Fries 🌶️", tier: "super" },
};
