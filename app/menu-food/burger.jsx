  ...
  if (loading) {
    return (
      <View style={styles.loadingScreen}>
        ...
        <Text style={styles.loadingText}>Preparing your burger...</Text>
      </View>
    );
  }
    ...
    <View style={styles.screen}>
      ...
      >
        ...
        <View style={styles.heroContainer}>
          <Image
            source={require("../../assets/img/menu-5.jpg")}
            style={[
              styles.heroImage,
              {
        ...
        <View style={styles.section}>
          {items.length === 0 ? (
            <View style={styles.emptyCard}>
              ...
              <Text style={styles.emptyTitle}>No burgers yet</Text>
