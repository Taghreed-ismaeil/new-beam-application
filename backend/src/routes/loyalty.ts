...
const RARITY_TOKEN_MAP: Record<string, { realToken: string; reveals: number }> = {
  ...
  // Gifts promo فتات batch — generated by prisma/seed-gifts-fattat.ts.
  POTATO_CUBES_QR_NORMAL: { realToken: 'MENU_a3449a1b', reveals: 1 },
  POTATO_CUBES_QR_RARE: { realToken: 'MENU_a3449a1b', reveals: 3 },
  POTATO_CUBES_QR_SUPER: { realToken: 'MENU_a3449a1b', reveals: 5 },
  SHAWARMA_RICE_FATTEH_QR_NORMAL: { realToken: 'MENU_1fe2e840', reveals: 1 },
  SHAWARMA_RICE_FATTEH_QR_RARE: { realToken: 'MENU_1fe2e840', reveals: 3 },
  SHAWARMA_RICE_FATTEH_QR_SUPER: { realToken: 'MENU_1fe2e840', reveals: 5 },
  SHAWARMA_FATTEH_QR_NORMAL: { realToken: 'MENU_46ae3411', reveals: 1 },
  SHAWARMA_FATTEH_QR_RARE: { realToken: 'MENU_46ae3411', reveals: 3 },
  SHAWARMA_FATTEH_QR_SUPER: { realToken: 'MENU_46ae3411', reveals: 5 },
  FALAFEL_FATTEH_QR_NORMAL: { realToken: 'MENU_dfdfa1fe', reveals: 1 },
  FALAFEL_FATTEH_QR_RARE: { realToken: 'MENU_dfdfa1fe', reveals: 3 },
  FALAFEL_FATTEH_QR_SUPER: { realToken: 'MENU_dfdfa1fe', reveals: 5 },
  MAC_CHEESE_QR_NORMAL: { realToken: 'MENU_c9d16a30', reveals: 1 },
  MAC_CHEESE_QR_RARE: { realToken: 'MENU_c9d16a30', reveals: 3 },
  MAC_CHEESE_QR_SUPER: { realToken: 'MENU_c9d16a30', reveals: 5 },
  MEXICAN_FRIES_QR_NORMAL: { realToken: 'MENU_13788f87', reveals: 1 },
  MEXICAN_FRIES_QR_RARE: { realToken: 'MENU_13788f87', reveals: 3 },
  MEXICAN_FRIES_QR_SUPER: { realToken: 'MENU_13788f87', reveals: 5 },
};
